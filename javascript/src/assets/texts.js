...
export const Texts = {
    ...
    about: 'Urban Identity can be described through collectively perceived traits and characteristics that distinguish one place from another.\n' +
        '\n' +
        'By browsing through the different neighborhoods of Munich, you can discover their collective image, constructed from mostly talked about topics through mentions by hashtag.',
