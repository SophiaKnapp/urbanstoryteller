...
if __name__ == '__main__':
    files = sorted( glob('../../data/processed/hashtag_network_publicSpaces/*.csv') )
    out_dir = '../../data/processed/hashtag_network_graphs_publicSpaces'
    path_frequency = '../../data/processed/hashtag_frequency_publicSpaces_plots_onevoteperuser/'
