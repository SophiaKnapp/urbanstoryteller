...
if __name__ == '__main__':
  files = sorted( glob('../../data/Instagram-API/Feed/Actors/PublicSpaces-hashtag-*/result/result.csv') )
  out_dir = '../../data/processed/hashtag_network_publicSpaces'
  ...
  for index, file in enumerate(files):
    ...
    quarter_name = file.replace('../../data/Instagram-API/Feed/Actors/PublicSpaces-hashtag-','').replace('/result/result.csv', '')
    print ('>> now processing:', quarter_name)
    df = read_result_csv(file)
    frequency_csv_path = '../../data/processed/hashtag_frequency_publicSpaces_onevoteperuser/' + quarter_name + '.csv'
